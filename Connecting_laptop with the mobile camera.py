...
# this for accessing the camera of my phone
camera_mobile = "http://192.168.0.104:8080/video"



# for reading 
cap.open(camera_mobile)
...
output = cv2.VideoWriter("C:\\Users\\mynam\\Downloads\\first_vid_capture_from_camera.mp4",fourcc,20.0,(680,480))# ,0) 
